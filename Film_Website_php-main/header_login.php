<?php 
  if(!isset($_SESSION['user'])){header("loaction:../authentication/register.php");}
?>
<header  class="header" data-header>
    <div class="container">
      ...
      <div class="header-actions">
        ...
        <button ><?php if($rod["profile_img"]==null){ ?>--><img src="" alt="profile_img" id="im1" ><?php }else{echo '<img class="rounded-circle" style="height:40px;width:40px;" src="data:image;base64,'.base64_encode($rod["profile_img"]).'"/>'; } ?></button>
        <?php
                  }?>
      ...
      <nav class="navbar" data-navbar>
        ...
        <ul class="navbar-list">
          ...
          <li>
            <a href="progress.php" class="navbar-link"> MOVIES IN PROGRESS</a>
          </li>

        

          <li>
            <a href="pricing.php" class="navbar-link">Pricing</a>
          </li>
          <li>
